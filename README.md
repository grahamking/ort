...
It is built the old fashioned way, in solid Rust. It doesn't slow you down with Python interpreters. This is a compact ~230 KiB ELF binary, with no dependencies, without even using the Rust stdlib.
